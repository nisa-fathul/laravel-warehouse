    ...
    <div id="pdf-report" class="bg-white rounded shadow-sm p-3 p-md-4">
      ...
      <div class="row align-items-center border-bottom pb-4 mb-4 g-3">
        <div class="col-12 col-md-7 d-flex align-items-center gap-3">
          <div class="bg-warning text-dark fw-black rounded d-flex align-items-center justify-content-center fw-bold fs-4" style="width: 50px; height: 50px;">SW</div>
          <div>
            <h5 class="mb-0 fw-bold text-dark text-uppercase tracking-wide">STOCKWISE — Warehouse Intelligence</h5>
        ...
        <div class="col-12 col-md-5 text-md-end">
          ...
          <div class="small fw-semibold mt-1 text-secondary">Periode: <span class="text-dark fw-bold">6 Bulan Terakhir</span></div>
        </div>
      </div>
      ...
      <div class="row g-4 mb-4">
        <div class="col-12 col-lg-6">
          <div class="card h-100 shadow-sm border-light">
            <div class="card-header bg-white py-3"><h6 class="mb-0 fw-bold text-secondary">Tren Revenue per Sales Rep</h6></div>
            <div class="card-body"><canvas id="lineChart" height="220"></canvas></div>
          </div>
        </div>
        <div class="col-12 col-lg-6">
          <div class="card h-100 shadow-sm border-light">
            <div class="card-header bg-white py-3"><h6 class="mb-0 fw-bold text-secondary">Pencapaian vs Target</h6></div>
      ...
      <div class="row g-4 mb-4">
        <div class="col-12 col-lg-6">
          <div class="card h-100 shadow-sm border-light">
            <div class="card-header bg-white py-3"><h6 class="mb-0 fw-bold text-secondary">Revenue per Kategori Produk</h6></div>
            <div class="card-body"><canvas id="doughnutChart" height="220"></canvas></div>
          </div>
        </div>
        <div class="col-12 col-lg-6">
          <div class="card h-100 shadow-sm border-light">
            <div class="card-header bg-white py-3"><h6 class="mb-0 fw-bold text-secondary">On-Time Delivery & Conversion Rate (%)</h6></div>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover align-middle w-100 report-datatable">
              ...
              <tbody class="small">
                ...
                <tr>
                  <td><span class="badge bg-danger bg-opacity-70 text-white fw-bold px-2 py-1">#3</span></td>
                  <td>
      ...
      <div class="row g-4 mb-4">
        <div class="col-12 col-lg-6">
          <div class="card h-100 shadow-sm border-light">
            <div class="card-header bg-white py-3"><h6 class="mb-0 fw-bold text-secondary">Revenue per Kategori</h6></div>
            <div class="card-body">
              <div class="table-responsive">
                  ...
                  <tbody class="small">
                    <tr>
                      ...
                      <td style="width: 100px;">
                        <div class="progress" style="height: 6px;"><div class="progress-bar bg-success" style="width: 45%"></div></div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div class="progress" style="height: 6px;"><div class="progress-bar bg-success" style="width: 35%"></div></div>
                      </td>
                    </tr>
                    <tr>
        ...
        <div class="col-12 col-lg-6">
          <div class="card h-100 shadow-sm border-light">
            <div class="card-header bg-white py-3"><h6 class="mb-0 fw-bold text-secondary">Top Customers</h6></div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-sm table-striped align-middle w-100 report-datatable-simple">
                  <thead class="table-light small text-secondary">
                  ...
                  <tbody class="small">
                    <tr>
                      ...
                      <td><span class="badge bg-success-subtle text-success rounded-pill px-2">Growing</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><span class="badge bg-warning-subtle text-warning rounded-pill px-2">At Risk</span></td>
                    </tr>
                  </tbody>
                </table>
              </div>
      ...
      <div class="card shadow-sm border-light">
        <div class="card-header bg-white py-3"><h6 class="mb-0 fw-bold text-secondary">Metrik Fulfillment Bulanan</h6></div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-striped table-hover align-middle w-100 report-datatable-simple">
              ...
              <tbody class="small font-monospace">
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center gap-2" style="width: 140px">
                      <div class="progress w-100" style="height: 6px;"><div class="progress-bar bg-success" style="width: 92%"></div></div>
                      <span>92.0%</span>
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="d-flex align-items-center gap-2" style="width: 140px">
                      <div class="progress w-100" style="height: 6px;"><div class="progress-bar bg-primary" style="width: 74%"></div></div>
                      <span>74.0%</span>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center gap-2">
                      <div class="progress w-100" style="height: 6px;"><div class="progress-bar bg-success" style="width: 94.2%"></div></div>
                      <span>94.2%</span>
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="d-flex align-items-center gap-2">
                      <div class="progress w-100" style="height: 6px;"><div class="progress-bar bg-primary" style="width: 78.5%"></div></div>
                      <span>78.5%</span>
                    </div>
                  </td>
                </tr>
      ...
      <div class="d-flex flex-column flex-md-row justify-content-between align-items-center border-top mt-4 pt-3 small text-muted font-monospace">
