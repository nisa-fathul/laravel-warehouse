...
<main id="main" class="main">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
            ...
            <button class="btn btn-sm btn-outline-warning text-dark" type="button" data-bs-toggle="collapse"
                data-bs-target="#dout-form-collapse" aria-expanded="false" aria-controls="dout-form-collapse"
                id="toggle-form-btn-out">
                Buka Form ▾
            </button>
        </div>
        <div class="collapse" id="dout-form-collapse">
            <div class="card-body bg-light-subtle">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" onchange="fillItemOut(this)">
                            ...
                            <option value="SKU-001" data-name="Laptop Asus ROG" data-unit="pcs" data-cost="1500.00"
                                data-stock="15">SKU-001 — Laptop Asus ROG (Stok: 15 pcs)</option>
                            <option value="SKU-002" data-name="Logitech G Pro X Wireless" data-unit="pcs"
                                data-cost="125.00" data-stock="45">SKU-002 — Logitech G Pro X Wireless (Stok: 45 pcs)
                            </option>
                            <option value="SKU-003" data-name="Monitor Dell 24 Inch" data-unit="unit" data-cost="200.00"
                                data-stock="8">SKU-003 — Monitor Dell 24 Inch (Stok: 8 unit)</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small fw-semibold">Nama Barang</label>
                        <input type="text" class="form-control" id="dout-item-name" placeholder="Otomatis terisi"
                            readonly>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control text-primary fw-bold" id="dout-stock" placeholder="—"
                            readonly>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="mt-4 pt-3 border-top d-flex gap-2">
                    <button class="btn btn-warning text-dark fw-bold" onclick="submitForm('dout')">✓ Simpan
                        Pengeluaran</button>
                    <button class="btn btn-light" type="button" data-bs-toggle="collapse"
                        data-bs-target="#dout-form-collapse">Batal</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <div class="progress" style="height: 10px;">
                    <div class="progress-bar bg-info" role="progressbar" style="width: 73%" aria-valuenow="73"
            ...
            <div class="mb-3">
                ...
                <div class="progress" style="height: 10px;">
                    <div class="progress-bar bg-secondary" role="progressbar" style="width: 15%" aria-valuenow="15"
                        aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </div>
            <div class="mb-0">
