            ...
            <div class="card-body bg-light-subtle">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" onchange="fillItem(this)">
                            ...
                            <option value="SKU-001" data-name="Laptop Asus ROG" data-unit="pcs" data-cost="1500.00">
                                SKU-001 — Laptop Asus ROG</option>
                            <option value="SKU-002" data-name="Logitech G Pro X Wireless" data-unit="pcs"
                                data-cost="125.00">SKU-002 — Logitech G Pro X Wireless</option>
                            <option value="SKU-003" data-name="Monitor Dell 24 Inch" data-unit="unit"
                                data-cost="200.00">SKU-003 — Monitor Dell 24 Inch</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small fw-semibold">Nama Barang</label>
                        <input type="text" class="form-control" id="din-item-name" placeholder="Otomatis terisi"
                            readonly>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="mt-4 pt-3 border-top d-flex gap-2">
                    ...
                    <button class="btn btn-light" type="button" data-bs-toggle="collapse"
                        data-bs-target="#din-form-collapse">Batal</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="table table-striped table-hover align-middle w-100" id="din-table">
                    ...
                    <tbody class="small">
                        <tr>
                            ...
                            <td><span
                                    class="badge bg-secondary-subtle text-secondary-emphasis rounded-pill">PO-2026-001</span>
                            </td>
                            ...
                            <td><span
                                    class="badge bg-success-subtle text-success border border-success-subtle rounded-pill">Good</span>
                            </td>
                            <td>Budi Santoso</td>
                        ...
                        <tr>
                            ...
                            <td><span
                                    class="badge bg-secondary-subtle text-secondary-emphasis rounded-pill">PO-2026-004</span>
                            </td>
                            ...
                            <td><span
                                    class="badge bg-danger-subtle text-danger border border-danger-subtle rounded-pill">Partial
                                    Damage</span></td>
                            <td>Siti Rahma</td>
